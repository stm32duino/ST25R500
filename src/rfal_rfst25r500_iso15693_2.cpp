...
ReturnCode RfalRfST25R500Class::rfalIso15693PhyConfigure(const rfalIso15693PhyConfig_t *config, const struct rfalIso15693StreamConfig **needed_stream_config)
{
...
ReturnCode RfalRfST25R500Class::rfalIso15693PhyGetConfiguration(rfalIso15693PhyConfig_t *config)
{
...
ReturnCode RfalRfST25R500Class::rfalIso15693VCDCode(uint8_t *buffer, uint16_t length, bool sendCrc, bool sendFlags, bool picopassMode,
...
ReturnCode RfalRfST25R500Class::rfalIso15693VICCDecode(const uint8_t *inBuf,
                                                       uint16_t inBufLen,
                                                       uint8_t *outBuf,
                                                       uint16_t outBufLen,
                                                       uint16_t *outBufPos,
